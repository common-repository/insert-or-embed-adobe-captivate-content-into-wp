...
Plugin URI: http://www.elearningfreak.com
...
if ( ! function_exists ( 'cap_embeder_register_plugin_links' ) ) {
	function cap_embeder_register_plugin_links( $links, $file ) {
		...
		if ( $file == $base ) {
			if ( ! is_network_admin() )
			$links[] = '<a href="https://www.elearningfreak.com/presenter/insert-or-embed-articulate-content-into-wordpress-plugin-premium/" target="_blank">' . __( 'Buy premium version','cap_embeder' ) . '</a>';
			...
			$links[] = '<a href="https://www.elearningfreak.com/presenter/insert-or-embed-articulate-content-into-wordpress-plugin-premium/" target="_blank">' . __( 'Maximum upload size','cap_embeder' ) . '</a>';
			$links[] = '<a href="https://www.elearningfreak.com/contact-us/" target="_blank">' . __( 'Support','cap_embeder' ) . '</a>';
		}
		return $links;
	}
}
